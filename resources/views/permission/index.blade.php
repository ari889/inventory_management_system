    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            ...
            <div class="dt-entry__header">
                ...
                <button type="button" style="font-size: 1.4rem" class="btn btn-primary btn-sm" onclick="showFormModal('Add New Permission', 'Save')"><i class="fas fa-plus-square mr-2"></i>Add New</button>
                    ...
                    <form id="form-filter">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <button type="button" class="btn btn-primary btn-sm float-right mr-2" id="btn-filter" data-toggle="tooltip" data-placement="top" data-original-title="Filter Data"><i class="fas fa-search"></i></button>
                            </div>
                        </div>
                    </form>
    ...
    table = $('#dataTable').DataTable({
        ...
        function dynamic_permission_field(row){
            html = `<tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-danger btn-sm remove_permission" data-toggle="tooltip" data-placement="top" data-original-title="Remove">
