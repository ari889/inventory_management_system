            ...
            <div class="dt-card">
                ...
                <div class="dt-card__body">
                    <form id="saveDataForm" method="POST">
                        @csrf
                        <input type="hidden" name="update_id" id="update_id" value="{{ $permission_data['role']->id }}">
                        <div class="row">
        ...
        $(document).on('click', '#update-btn', function () {
            ...
            if($('.module:checked').length >= 1){
                $.ajax({
                    ...
                    cache: false,
                    beforeSend: function(){
                        $('#update-btn').addClass('kt-prinner kt-spinner-md kt-spinner--light')
                    },
                    complete: function(){
                        $('#update-btn').removeClass('kt-prinner kt-spinner-md kt-spinner--light')
                    },
