            ...
            <span class="dt-brand__logo">
                <a class="dt-brand__logo-link" href="{{ url('/') }}">
                    <img class="d-none d-lg-inline-block"
                        src="{{ asset('storage/'.LOGO_PATH.config('settings.site_logo')) }}" alt="Logo"
                                ...
                                <div class="h-auto">
                                    ...
                                    <a href="{{ url('product-quantity-alert') }}" class="media">
                                        ...
                                        <span class="media-body">
                                            <span class="message">
                                                {{ $alert_product }} products exced alert quantity
                                            </span>
                                        </span>
                                        <!-- /media body -->
                                ...
                                <div class="h-auto">
                                    ...
                                    <a href="javascript:void(0)" class="media">
                                        ...
                                        <span class="media-body text-truncate">
                                            ...
                                            <span class="message text-light-gray text-truncate">Okay.. I will be waiting
                                                for your...</span>
                                        </span>
                                        <!-- /media body -->
                                    ...
                                    <a href="javascript:void(0)" class="media">
                                        ...
                                        <!-- Avatar -->
                                        <img class="dt-avatar mr-3" src="images/user-avatar/stella-johnson.jpg"
                                            alt="User">
                                        <!-- avatar -->
                                    ...
                                    <a href="javascript:void(0)" class="media">
                                        ...
                                        <!-- Avatar -->
                                        <img class="dt-avatar mr-3" src="images/user-avatar/domnic-brown.jpg"
                                            alt="User">
                                        <!-- avatar -->
                ...
                <ul class="dt-nav">
                    <li class="dt-nav__item dropdown">
                        ...
                        <a href="#" class="dt-nav__link dropdown-toggle no-arrow dt-avatar-wrapper"
                            ...
                            @if(Auth::user()->avatar)
                            <img class="dt-avatar size-40" src='storage/"{{ USER_AVATAR_PATH.Auth::user()->avatar }}'
                                alt='{{ Auth::user()->name }}' style='width: 50px'>
                            @else
                            <img class="dt-avatar size-40"
                                src='images/{{ (Auth::user()->gender == 1 ? 'male' : 'female') }}.svg'
                                alt='{{ Auth::user()->name }}' style='width: 50px'>
                            @endif
                        </a>
                        <!-- /dropdown link -->
