    ...
    <div class="dt-header__container">
      ...
      <div class="dt-brand">
        ...
        <a class="dt-brand__logo-link" href="{{ url('/') }}">
            <img class="d-none d-lg-inline-block" src="{{ asset('storage/'.LOGO_PATH.config('settings.site_logo')) }}" alt="Logo" style="max-width: 100px;max-height:50px;"/>
            <img class="dt-brand__logo-symbol d-lg-none" src="{{ asset('storage/'.LOGO_PATH.config('settings.site_logo')) }}" alt="Logo"/>
        </a>
      </span>
        <!-- /brand logo -->
          ...
          <ul class="dt-nav">
            <li class="dt-nav__item dropdown">
              ...
              <a href="#" class="dt-nav__link dropdown-toggle no-arrow dt-avatar-wrapper"
                 ...
                 @if(Auth::user()->avatar)
                 <img class="dt-avatar size-40" src='storage/"{{ USER_AVATAR_PATH.Auth::user()->avatar }}' alt='{{ Auth::user()->name }}' style='width: 50px'>
                 @else
                 <img class="dt-avatar size-40" src='images/{{ (Auth::user()->gender == 1 ? 'male' : 'female') }}.svg' alt='{{ Auth::user()->name }}' style='width: 50px'>
                 @endif
              </a>
              <!-- /dropdown link -->
              ...
              <div class="dropdown-menu dropdown-menu-right" style="left: 50px;min-width: 200px;">
                <div class="dt-avatar-wrapper flex-nowrap p-6 mt--5 bg-gradient-purple text-white rounded-top">
                  @if(Auth::user()->avatar)
                  <img class="dt-avatar" src='storage/"{{ USER_AVATAR_PATH.Auth::user()->avatar }}' alt='{{ Auth::user()->name }}' style='width: 50px'>
                  @else
                  <img class="dt-avatar" src='images/{{ (Auth::user()->gender == 1 ? 'male' : 'female') }}.svg' alt='{{ Auth::user()->name }}' style='width: 50px'>
                  @endif
