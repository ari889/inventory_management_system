    ...
    <div class="row pt-5">
      ...
      <div class="col-md-6">
        <div class="card line-chart">
          ...
          <div class="card-body">
            <canvas id="cashFlow" data-color="#038fde" data-color_rgba="rgba(3, 143, 222, 1)" data-received="{{ json_encode($payment_received) }}" data-sent="{{ json_encode($payment_sent) }}" data-month="{{ json_encode($month) }}" data-label1="Payment Received" data-label2="Payment Sent"></canvas>
          </div>
        </div>
      </div>
      <!-- end :: cash flow Graph -->

      <!-- Start :: transection chart Graph -->
      <div class="col-md-6">
        <div class="card doughnut-chart">
          ...
          <div class="card-body">
            <canvas id="transectionChart" data-color="#038fde" data-color_rgba="rgba(3, 143, 222, 1)" data-sale="{{ $sale }}" data-purchase="{{ $purchase }}" data-expense="{{ $expense }}" data-label1="Purchase" data-label2="Sale" data-label3="Expense"></canvas>
          </div>
        </div>
      </div>
      <!-- end :: transection chart Graph -->
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card bar-chart">
          ...
          <div class="card-body">
            <canvas id="yearlyReportChart" data-sale_chart_value="{{ json_encode($yearly_sale_amount) }}" data-purchase_chart_value="{{ json_encode($yearly_purchase_amount) }}" data-label1="Purchase Amount" data-label2="Sale Amount"></canvas>
          </div>
        </div>
      </div>
    </div>
...
<script>
    $(document).ready(function () {
      ...
      // Transection chart
      var TRANSECTION = $('#transectionChart');

      if(TRANSECTION.length > 0){

        brandPrimary = TRANSECTION.data('color');
        brandPrimaryRgba = TRANSECTION.data('color_rgba');
        var sale = TRANSECTION.data('sale');
        var purchase = TRANSECTION.data('purchase');
        var expense = TRANSECTION.data('expense');
        var label1 = TRANSECTION.data('label1');
        var label2 = TRANSECTION.data('label2');
        var label3 = TRANSECTION.data('label3');

        var transection_chart = new Chart(TRANSECTION, {
          type : 'doughnut',
          data: {
            ...
            datasets: [
              {
                ...
                borderWidth: 1,
                data : [yearly_purchase_amount[0],yearly_purchase_amount[1],yearly_purchase_amount[2],yearly_purchase_amount[3],yearly_purchase_amount[4],yearly_purchase_amount[5],yearly_purchase_amount[6],yearly_purchase_amount[7],yearly_purchase_amount[8],yearly_purchase_amount[9],yearly_purchase_amount[10],yearly_purchase_amount[11],]
              },
              {
                label : label2,
                backgroundColor: [
                ...
                borderWidth: 1,
                data : [yearly_sale_amount[0],yearly_sale_amount[1],yearly_sale_amount[2],yearly_sale_amount[3],yearly_sale_amount[4],yearly_sale_amount[5],yearly_sale_amount[6],yearly_sale_amount[7],yearly_sale_amount[8],yearly_sale_amount[9],yearly_sale_amount[10],yearly_sale_amount[11],]
              }
            ],
