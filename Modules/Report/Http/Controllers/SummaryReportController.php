...
class SummaryReportController extends Controller
{
    ...
    public function index()
    {
        if(permission('summary-report-access')){
            $this->setPageData('Summery Report', 'Summery Report', 'fas fa-file-signature');
    ...
    public function details(Request $request){
        if($request->ajax()){
            ...
            return view('report::summary-report.report', compact('purchase', 'total_purchase', 'sale', 'total_sale', 'expense', 'total_expense', 'payroll', 'total_payroll', 'total_item', 'payment_received_number', 'payment_received', 'cash_payment_sale', 'cheque_payment_sale', 'mobile_payment_sale', 'payment_paid_number', 'payment_paid', 'cash_payment_purchase', 'cheque_payment_purchase', 'mobile_payment_purchase', 'warehouse_name', 'warehouse_sale', 'warehouse_purchase', 'warehouse_expense'))->render();
        }
    }
}
