                        ...
                        <div class="row">
                            <div class="form-group col-md-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control daterangepicker-field" value="{{ date('Y-m-').'-01' }} To {{ date('Y-m-d') }}">
                            ...
                            <div class="form-group col-md-1" style="padding-top: 20px;">
                                <button type="button" class="btn btn-primary btn-sm float-right mr-2" id="btn-filter"
                                    data-toggle="tooltip" data-placement="top" data-original-title="Finter Data">Search</button>
                            </div>
                        </div>
                    </form>
                    <div class="col-md-12">
