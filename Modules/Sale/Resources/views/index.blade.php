        ...
        <div class="col-xl-12">
            ...
            <div class="dt-entry__header">
                ...
                @if (permission('sale-add'))
                    <a href="{{ route('sale.add') }}" style="font-size: 1.4rem" class="btn btn-primary btn-sm"><i class="fas fa-plus-square mr-2"></i>Add New</a>
                @endif
                    ...
                    <form id="form-filter">
                        <div class="row">
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" name="sale_no" id="sale_no" class="form-control" placeholder="Enter sale number">
                            </div>
