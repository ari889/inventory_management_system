            ...
            if($request->ajax()){
                ...
                foreach ($list as $value) {
                    ...
                    if(permission('sale-edit')){
                        $action .= ' <a class="dropdown-item edit_data" href="'.route('sale.edit', ['id' => $value->id]).'"><i class="fas fa-edit text-primary"></i> Edit</a>';
                    }
        ...
        if($request->ajax()){
            if(permission('sale-edit')){
                ...
                try {
                    ...
                    $saleData->sale_products()->sync($products);
                    $output = $sale ? ['status' => 'success', 'message' => 'Data updated successfully!'] :['status' => 'error', 'message' => 'Data failed to update!'];
        ...
        if($request->ajax()){
            if(permission('sale-delete')){
                ...
                try {
                    ...
                    $output = $result ? ['status' => 'success', 'message' => 'Data deleted successfully!'] :['status' => 'error', 'message' => 'Data failed to delete!'];
