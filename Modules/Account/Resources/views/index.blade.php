        ...
        <div class="col-xl-12">
            ...
            <div class="dt-entry__header">
                ...
                @if (permission('account-add'))
                    <button type="button" style="font-size: 1.4rem" class="btn btn-primary btn-sm" onclick="showFormModal('Add New Account', 'Save')"><i class="fas fa-plus-square mr-2"></i>Add New</button>
                @endif
                    ...
                    <form id="form-filter">
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="account_no" id="account_no" class="form-control" placeholder="Enter category name">
                            </div>
                            <div class="form-group col-md-4">
