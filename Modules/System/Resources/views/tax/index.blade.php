        ...
        <div class="col-xl-12">
            ...
            <div class="dt-entry__header">
                ...
                @if (permission('tax-add'))
                    <button type="button" style="font-size: 1.4rem" class="btn btn-primary btn-sm" onclick="showFormModal('Add New Tax', 'Save')"><i class="fas fa-plus-square mr-2"></i>Add New</button>
                @endif
