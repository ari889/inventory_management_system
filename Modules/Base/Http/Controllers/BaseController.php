...
class BaseController extends Controller
{
    ...
    protected function delete_message($result){
        return $result ? ['status' => 'success', 'message' => 'Data has been deleted successfully!'] : ['status' => 'error', 'message' => 'Failed to delete data!'];
    }

    protected function bulk_delete_message($result){
        return $result ? ['status' => 'success', 'message' => 'Selected data has been deleted successfully!'] : ['status' => 'error', 'message' => 'Failed to selected delete data!'];
    }
