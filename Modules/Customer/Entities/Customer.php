...
class Customer extends BaseModel
{
    ...
    private function get_datatable_query()
    {
        if(permission('customer-bulk-delete')){
            $this->column_order = [null, 'id', 'customer_group_id', 'name', 'company_name', 'vat_number', 'email', 'phone', 'address', 'city', 'state', 'postal_code', 'country', 'status', null];
        }else{
            $this->column_order = ['name', 'customer_group_id', 'company_name', 'vat_number', 'email', 'phone', 'address', 'city', 'state', 'postal_code', 'country', 'status', null];
        }
