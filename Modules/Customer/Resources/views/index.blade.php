        ...
        <div class="col-xl-12">
            ...
            <div class="dt-entry__header">
                ...
                @if (permission('customer-add'))
                    <button type="button" style="font-size: 1.4rem" class="btn btn-primary btn-sm" onclick="showFormModal('Add New Customer', 'Save')"><i class="fas fa-plus-square mr-2"></i>Add New</button>
                @endif
                    ...
                    <form id="form-filter">
                        <div class="row">
                            <div class="form-group col-md-3">
                                ...
                                <select name="customer_group_id" id="customer_group_id" class="selectpicker" data-live-search-placeholder="Search" data-live-search="true">
