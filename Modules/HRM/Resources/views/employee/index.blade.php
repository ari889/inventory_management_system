        ...
        <div class="col-xl-12">
            ...
            <div class="dt-entry__header">
                ...
                @if (permission('employee-add'))
                    <button type="button" style="font-size: 1.4rem" class="btn btn-primary btn-sm" onclick="showFormModal('Add New Employee', 'Save')"><i class="fas fa-plus-square mr-2"></i>Add New</button>
                @endif
                    ...
                    <form id="form-filter">
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select name="department_id" id="department_id" class="selectpicker w-100" data-live-search-placeholder="Search" data-live-search="true">
