            ...
            <div class="modal-body">
                <form id="store_or_update_form" method="POST">
                    <div class="row">
                        ...
                        <x-form.selectbox labelName="Employee" name="employee_id" col="col-md-6" class="selectpicker">
                        ...
                        <x-form.textbox labelName="Check Out" name="check_out" col="col-md-6" class="time" />
                    </div>
                </form>
            </div>
            <!-- /modal body -->
