        ...
        <div class="col-xl-12">
            ...
            <div class="dt-entry__header">
                ...
                @if (permission('payroll-add'))
                    <button type="button" style="font-size: 1.4rem" class="btn btn-primary btn-sm" onclick="showFormModal('Add New Payroll', 'Save')"><i class="fas fa-plus-square mr-2"></i>Add New</button>
                @endif
                ...
                <div class="dt-card__body">
                    ...
                    <form id="form-filter">
                        <div class="row">
                            ...
                            <x-form.selectbox labelName="Account" name="account_id" col="col-md-3" class="selectpicker">
                                @if (!$accounts->isEmpty())
