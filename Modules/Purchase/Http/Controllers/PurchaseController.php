            ...
            if($request->ajax()){
                ...
                foreach ($list as $value) {
                    ...
                    if(permission('purchase-edit')){
                        $action .= ' <a class="dropdown-item edit_data" href="'.route('purchase.edit', ['id' => $value->id]).'"><i class="fas fa-edit text-primary"></i> Edit</a>';
                    }
                    if(permission('purchase-view')){
                        $action .= ' <a class="dropdown-item view_data" href="'.route('purchase.details', ['id' => $value->id]).'"><i class="fas fa-eye text-success"></i> View</a>';
                    }
                    if(permission('purchase-view')){
                    ...
                    if(!$purchaseData->purchase_products->isEmpty()){
                        foreach ($purchaseData->purchase_products as $purchase_product) {
                            ...
                            if($purchase_unit->operator == '*'){
                                $qty = $old_received_qty * $purchase_unit->operation_value;
                            }else{
                                $qty = $old_received_qty / $purchase_unit->operation_value;
                            }
