        ...
        <div class="col-xl-12">
            ...
            <div class="dt-entry__header">
                ...
                <div class="d-flex flex-wrap">
                    <button class="btn btn-primary btn-sm mr-3" id="print-invoice"><i class="fas fa-print"></i> Print</button>
                    <!-- /entry heading -->
                    <a href="{{ route('sale') }}" class="btn btn-danger btn-sm"><i class="fas fa-arow-left mr-2"></i>Back</a>
                </div>
                        ...
                        <div class="invoice overflow-auto">
                            <div>
                                <table>
                                    <tr>
                                        <td>
                                            <a href="{{ route('home') }}" class="logo_text">
                                                <img src="{{ asset('storage/'.LOGO_PATH.config('settings.site_logo')) }}" alt="Logo" style="max-width: 200px;"/>
                                            </a>
                                        </td>
                                        <td class="text-right">
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td width="50%" class="text-right">
                                            ...
                                            <div class="m-0">Date: {{ date('d-M-Y', strtotime($purchase->created_at)) }}</div>
                                        </td>
                                    </tr>
                                </table>
                                            ...
                                            @if (!$purchase->purchase_products->isEmpty())
                                                @foreach ($purchase->purchase_products as $key => $purchase_product)
                                                    <tr>
                                                        ...
                                                        <td class="text-center qty">{{ $purchase_product->pivot->qty.' '.DB::table('units')->where('id', $purchase_product->pivot->purchase_unit_id)->value('unit_name') }}</td>
                                ...
                                <table>
                                    <tr>
                                        <td>
                                            <div class="thanks">Yhank you!</div>
                                            <div class="notices">
                                                <div>NOTE:</div>
