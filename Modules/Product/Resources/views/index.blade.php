        ...
        <div class="col-xl-12">
            ...
            <div class="dt-entry__header">
                ...
                @if (permission('product-add'))
                    <button type="button" style="font-size: 1.4rem" class="btn btn-primary btn-sm" onclick="showStoreFormModal('Add New Product', 'Save')"><i class="fas fa-plus-square mr-2"></i>Add New</button>
                @endif
...
function showStoreFormModal(modal_title, btn_text){
    ...
    $('#store_or_update_modal .modal-title').html( '<i class="fas fa-plus-square mr-2"></i>' + modal_title);
