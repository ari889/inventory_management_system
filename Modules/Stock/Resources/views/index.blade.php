                ...
                <div class="dt-card__body">
                    ...
                    <form id="form-filter">
                        <div class="row justify-content-center">
                            ...
                            <x-form.selectbox labelName="Warehouse" name="warehouse_id" col="col-md-2" class="selectpicker">
                            ...
                            <div class="form-group col-md-2 pt-24 text-left">
                                <button type="button" class="btn btn-danger btn-sm float-left mr-2" id="btn-reset" data-toggle="tooltip" data-placement="top" data-original-title="Reset Data"><i class="fas fa-redo-alt"></i></button>
                                <button type="button" class="btn btn-primary btn-sm float-left mr-2" id="btn-filter" data-toggle="tooltip" data-placement="top" data-original-title="Finter Data"><i class="fas fa-search"></i></button>
                            </div>
                        </div>
                    </form>
