...
{
    protected $data = [
        ['menu_id' => 1, 'type' => 2, 'module_name' => 'Dashboard', 'divider_title' => null, 'icon_class' => 'fas fa-techometer', 'url' => '/', 'order' => 1, 'parent_id' => null],
        ...
        ['menu_id' => 1, 'type' => 2, 'module_name' => 'Menu', 'divider_title' => null, 'icon_class' => 'fas fa-list', 'url' => 'menu', 'order' => 7, 'parent_id' => null],
