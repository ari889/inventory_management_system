...
mix.js('resources/js/app.js', 'public/js')
    ...
    .copy('resources/asset/js/chart.min.js', 'public/js/chart.min.js')
    .copy('resources/asset/js/jquery-ui.js', 'public/js/jquery-ui.js')
    .copy('resources/asset/js/script.js', 'public/js/script.js')
    .copyDirectory('resources/asset/css/gaxon-icon/fonts', 'public/css/fonts')
    .copyDirectory('resources/asset/fonts/noir-pro', 'public/fonts');
