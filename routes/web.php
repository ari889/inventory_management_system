...
Route::group(['middleware' => ['auth']], function(){
    ...
    Route::group(['prefix' => 'menu', 'as' => 'menu.'], function(){
        ...
        // module routes
        Route::get('builder/{id}', 'ModuleController@index')->name('build');
    ...
    Route::group(['prefix' => 'user', 'as' => 'user.'], function(){
        ...
        Route::post('order/{user}', 'UserController@orderItem')->name('order');
    ...
    Route::post('general-setting', 'SettingController@generalSetting')->name('general.setting');
    Route::post('mail-setting', 'SettingController@mailSetting')->name('mail.setting');
