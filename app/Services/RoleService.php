...
use App\Models\PermissioneRole;
...
class RoleService extends BaseService{
    ...
    public function edit(int $id){
        $role = $this->role->find_data_module_permission($id);
        $role_module = [];
    ...
    public function delete(Request $request){
        $role = $this->role->find_data_module_permission($request->id);
    ...
    public function bulk_delete(Request $request){
        if(!empty($request->ids)){
            ...
            if(!empty($delete_list)){
                ...
                $delete_permission_role = PermissioneRole::whereIn('role_id', $delete_list)->delete();
                if($delete_module_role && $delete_permission_role){
